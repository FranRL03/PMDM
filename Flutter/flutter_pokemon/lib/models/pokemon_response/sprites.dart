...
class Sprites {
	...
	factory Sprites.fromPokemonResponse(Map<String, dynamic> data) => Sprites(
				...
				other: data['other'] == null
						? null
						: Other.fromPokemonResponse(data['other'] as Map<String, dynamic>),
				versions: data['versions'] == null
						? null
						: Versions.fromPokemonResponse(data['versions'] as Map<String, dynamic>),
			);
	...
	Map<String, dynamic> toPokemonResponse() => {
				...
				'other': other?.toPokemonResponse(),
				'versions': versions?.toPokemonResponse(),
			};
  ...
  /// Parses the string and returns the resulting Json object as [Sprites].
	factory Sprites.fromJson(String data) {
		return Sprites.fromPokemonResponse(json.decode(data) as Map<String, dynamic>);
	}
  /// `dart:convert`
  ///

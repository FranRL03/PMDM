...
class UltraSunUltraMoon {
	...
	factory UltraSunUltraMoon.fromPokemonResponse(Map<String, dynamic> data) {
  ...
  /// Parses the string and returns the resulting Json object as [UltraSunUltraMoon].
	factory UltraSunUltraMoon.fromJson(String data) {
		return UltraSunUltraMoon.fromPokemonResponse(json.decode(data) as Map<String, dynamic>);
	}
  /// `dart:convert`
  ///

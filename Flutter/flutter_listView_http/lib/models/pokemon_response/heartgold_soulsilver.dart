...
class HeartgoldSoulsilver {
	...
	factory HeartgoldSoulsilver.fromPokemonResponse(Map<String, dynamic> data) {
  ...
  /// Parses the string and returns the resulting Json object as [HeartgoldSoulsilver].
	factory HeartgoldSoulsilver.fromJson(String data) {
		return HeartgoldSoulsilver.fromPokemonResponse(json.decode(data) as Map<String, dynamic>);
	}
  /// `dart:convert`
  ///

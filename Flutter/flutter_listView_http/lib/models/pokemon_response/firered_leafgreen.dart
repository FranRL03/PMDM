...
class FireredLeafgreen {
	...
	factory FireredLeafgreen.fromPokemonResponse(Map<String, dynamic> data) {
  ...
  /// Parses the string and returns the resulting Json object as [FireredLeafgreen].
	factory FireredLeafgreen.fromJson(String data) {
		return FireredLeafgreen.fromPokemonResponse(json.decode(data) as Map<String, dynamic>);
	}
  /// `dart:convert`
  ///

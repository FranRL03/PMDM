...
class BlackWhite {
	...
	factory BlackWhite.fromPokemonItem(Map<String, dynamic> data) {
		return BlackWhite(
			animated: data['animated'] == null
						? null
						: Animated.fromPokemonItem(data['animated'] as Map<String, dynamic>),
	...
	Map<String, dynamic> toPokemonItem() => {
				'animated': animated?.toPokemonItem(),
  ...
  /// Parses the string and returns the resulting Json object as [BlackWhite].
	factory BlackWhite.fromJson(String data) {
		return BlackWhite.fromPokemonItem(json.decode(data) as Map<String, dynamic>);
	}
  /// `dart:convert`
  ///

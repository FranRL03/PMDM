...
class Sprites {
	...
	factory Sprites.fromPokemonItem(Map<String, dynamic> data) => Sprites(
				...
				other: data['other'] == null
						? null
						: Other.fromPokemonItem(data['other'] as Map<String, dynamic>),
				versions: data['versions'] == null
						? null
						: Versions.fromPokemonItem(data['versions'] as Map<String, dynamic>),
			);
	...
	Map<String, dynamic> toPokemonItem() => {
				...
				'other': other?.toPokemonItem(),
				'versions': versions?.toPokemonItem(),
			};
  ...
  /// Parses the string and returns the resulting Json object as [Sprites].
	factory Sprites.fromJson(String data) {
		return Sprites.fromPokemonItem(json.decode(data) as Map<String, dynamic>);
	}
  /// `dart:convert`
  ///

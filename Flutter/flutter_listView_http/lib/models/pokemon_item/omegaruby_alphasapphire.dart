...
class OmegarubyAlphasapphire {
	...
	factory OmegarubyAlphasapphire.fromPokemonItem(Map<String, dynamic> data) {
  ...
  /// Parses the string and returns the resulting Json object as [OmegarubyAlphasapphire].
	factory OmegarubyAlphasapphire.fromJson(String data) {
		return OmegarubyAlphasapphire.fromPokemonItem(json.decode(data) as Map<String, dynamic>);
	}
  /// `dart:convert`
  ///

...
import 'package:flutter_navegacion_mdb/widget/people_widget.dart';

import '../models/people_item/people_item.dart';
import 'package:http/http.dart' as http;

Future<PeopleResponse> fetchPeople() async {
  final response =
      await http.get(Uri.parse('https://api.themoviedb.org/3/person/popular?api_key=b448b25869241da85a01f82d0167801c'));
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                return PeopleWidget(peopleList: snapshot.data!.results!);
                  // return PeopleWidget(peopleItem: snapshot.data!.results!);

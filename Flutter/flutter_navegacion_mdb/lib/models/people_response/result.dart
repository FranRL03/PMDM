...
class Result {
	...
	factory Result.fromPeopleItem(Map<String, dynamic> data) => Result(
				...
				knownFor: (data['known_for'] as List<dynamic>?)
						?.map((e) => KnownFor.fromPeopleItem(e as Map<String, dynamic>))
						.toList(),
			);
	...
	Map<String, dynamic> toPeopleItem() => {
				...
				'known_for': knownFor?.map((e) => e.toPeopleItem()).toList(),
			};
  ...
  /// Parses the string and returns the resulting Json object as [Result].
	factory Result.fromJson(String data) {
		return Result.fromPeopleItem(json.decode(data) as Map<String, dynamic>);
	}
  /// `dart:convert`
  ///
